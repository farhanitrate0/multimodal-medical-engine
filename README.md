...
### Core Features
1. **Radiological Diagnosis Mode (Explainable AI):** Evaluates chest radiographs for pneumonia using a custom PyTorch ResNet50 model. It features a Gradient-weighted Class Activation Mapping (Grad-CAM) hook to visually highlight the neural network's focal regions.
...
## Demo
*[Replace this line with your screen-recording GIF or video link]*
